/*Modificando 3;
En esta versión hemos colocado la activación d elos leds al principio como testeo rapido antes de comenzar el programa original.
*/
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------- 
 /*crearemos condicion para restringir el ángulo de inclinación (5º de inclinación máximo)
