...
//-------------------------------------------------------------------------------------------------------------------------------------------------------------------------
//----------------rectificación autoequilibrio-----------------------------------------------------------------------------------------------------------------------------
                  
                  if(tabla<-0.01){dire=dire+10;}
                  else if(tabla>0.01){dire=dire-10;};

//condicionante si el angulo de tabla es menor a -0.01 la direccion aumentara en 10, sino si tabla es mayor a 0.1 direccion aumentara en 10.                  
...
velo=map((tabla*dire*1000), 0,5000, 0,90);// tabla * resolución, De 0 al valor de resolución, de 0 hasta el máximo 255.(si jugamos con el máximo podemos ajustar la velocidad)
